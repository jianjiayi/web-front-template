// 默认通过src/styles/antd.theme.less 修改
// 此js可以全局修改
/* antd组件按需加载&样式覆盖等 */
// {
...
module.exports = {
  '@primary-color': 'rgba(99,126,241,1)',
  // '@btn-primary-bg': 'rgba(99,126,241,1)',
  // '@menu-dark-color': '#29355f',
  // '@menu-dark-bg': '#29355f',
  // '@menu-dark-highlight-color': '#4c66a8',
  // '@menu-dark-item-hover-bg': '#4c66a8',
  // '@menu-dark-arrow-color': '#4c66a8',
